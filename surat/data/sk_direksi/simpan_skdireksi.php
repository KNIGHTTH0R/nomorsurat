...
$query = "insert into sk_dir (nomor_skdir, id_perusahaan, id_document, id_department, id_penandatangan, tanggal, keterangan, ID_user) values ('','$id_perusahaan','$id_document','$id_department','$id_penandatangan','$tanggal','$keterangan','$ID_user')";
