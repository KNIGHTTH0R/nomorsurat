        ...
        <div class="maincontent noright">
        	<div class="maincontentinner">
                ...
                <ul class="maintabmenu">
                	<li class="current"><a href="#">Laporan Klinik</a></li>
                </ul><!--maintabmenu-->
                 
                      <div class="content">
 <div class="contenttitle radiusbottom0">
                	<h2 class="table"><span>Laporan Data Kunjungan Pasien</span></h2>
                </div>
</br>
Laporan Berdasarkan Tanggal :
<form id="form1" name="form1" method="post" action="../../../laporan/pasien_tgl.php">
Dari Tanggal :
...
<form id="form2" name="form2" method="post" action="../../../laporan/pasien_bln.php">
...
<form id="form3" name="form3" method="post" action="../../../laporan/pasien_thn.php">
  <label for="select"></label>
  <select name="tgl_awal" id="select">
