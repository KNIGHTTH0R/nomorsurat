...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2014 at 08:13 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=200062 ;
...
(200059, 'khhryr', '2014-02-13', 'rtrtr', 'rtrtrtrtr', 700048, 300003),
(200060, 'khhryr', '2014-02-13', 'rtrtr', 'rtrtrtrtr', 700048, 300003),
(200061, 'rtrtr', '2014-02-20', 'trtr765767676', 'oooooooooooooooo', 700048, 300003);
...
INSERT INTO `kunjungan_pasien` (`ID_kunjungan`, `no_kunjungan`, `ID_dokter`, `ID_pasien`, `ID_obat`, `tanggal_kunjungan`, `diagnosa_pasien`, `keterangan`) VALUES
(5, 'KJ-001', 100002, 600003, 500006, '2014-02-18', 'wrwrw', 'rwr'),
(6, 'KJ-002', 100003, 600001, 500014, '2013-12-25', 'terkena positif HIV tapi belum aids', 'lekas sembuh ya :)');
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=700049 ;
...
(110001, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'konselor', 'login', '2014-02-18 06:02:55', '2014-02-08 00:00:00');
