...
<p align="left" style="margin-left:60px;"><a href="input_skuasa.php"><img src="../../../images/tambah.png" width="38" height="38" /><br />Tambah Data</a></p> </br>
    ...
    <td><div align="center"><strong>Aksi</strong></div></td>
       ...
       <?php
      $query = "select nomor_skuasa,tanggal, nama_perusahaan, keterangan, nama_lengkap from suratkuasa inner join user on user.ID_user=suratkuasa.ID_user inner join tb_perusahaan on tb_perusahaan.id_perusahaan = suratkuasa.id_perusahaan";
...
while($data=mysql_fetch_array($exec)){ 
  ...
  <tr>
    ...
    <td><div align="center"><?php echo $data['nomor_skuasa']; ?></div></td>
    ...
    <td><div align="center"><a href="delete_skuasa.php?id=<?php echo $data['id']; ?>"><img src="../../images/delete.png" width="20" height="20"/></a></div></td>
  </tr>
