...
<br></br>
<br>Laporan Keseluruhan Data Penelepon</br>
<br></br>
<br></br>
...
<table width="100%" border="1" cellspacing="1" cellpadding="5">
  <tr style="font-size:9px;  background-color:#e9eeff">
    ...
    <th width="20%" scope="col">Kode Penelepon</th>
    <th width="20%" scope="col">Nama Penelepon</th>
    <th width="15%" scope="col">Jenis Kelamin</th>
    <th width="15%" scope="col">Umur</th>
  </tr>';
 ...
 $html .= '  <tr style="font-size:7px; background-color:#ffffff">
    <th scope="row">  '.$no.' </th>
    <td>'.$data["no_penelepon"].'</td>
    <td>'.$data["nama_penelepon"].'</td>
