...
$no_rm = $_GET['kode'];
$alamat_pasien = $_GET['alamat'];

$query1 = "select * from kunjungan_pasien, pasien, dokter, obat where pasien.ID_pasien='$ID_pasien' and kunjungan_pasien.ID_pasien='$ID_pasien' and pasien.ID_pasien = kunjungan_pasien.ID_pasien and dokter.ID_dokter = kunjungan_pasien.ID_dokter and obat.ID_obat = kunjungan_pasien.ID_obat";
...
<table width="100%" style="font-size:10px;" border="0" cellspacing="1" cellpadding="5">
  <tr>
    ...
    <th width="80%" scope="col">'.$no_rm.'</th>
  </tr>
  <tr>
...
<table width="100%" border="1" cellspacing="1" cellpadding="5">
  <tr style="font-size:9px;  background-color:#e9eeff">
    ...
    <th width="12%" scope="col">nama dokter</th>
    <th width="13%" scope="col">nama obat</th>
    <th width="25%" scope="col">diagnosa</th>
