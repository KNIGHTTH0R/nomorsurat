...
<p><label>Kode Perusahaan *</label>
            ...
            ?>
                        ...
                        <p><label>Jenis Dokumen*</label>
                            <span class="field" >
                            <select name="nama_document" id="id_document" required="required"> 
                  <?php
...
<?php }?>
                        ...
                        <p><label>Department*</label>
                            <span class="field" >
                            <select name="nama_department" id="id_department" required="required"> 
                  <?php
...
<?php }?>
                        ...
                        <p><label>Penandatangan*</label>
                            ...
                            <select name="penandatangan" id="penandatangan" required="required"> 
                  <?php
