...
<p align="left" style="margin-left:60px;"><a href="input_user.php"><img src="../../../images/tambah.png" width="38" height="38" /><br />Tambah Data</a></p> </br>
    ...
    <td><div align="center"><strong>Nama Lengkap</strong></div></td>
     <td><div align="center"><strong>Level User</strong></div></td>
    <td><div align="center"><strong>Aksi</strong></div></td>
       ...
       <?php
       $query = "select nama_lengkap, level_user from user inner join level on user.id_level = level.id_level";
...
while($data=mysql_fetch_array($exec)){ 
  ...
  <tr>
    ...
    <td><div align="center"><?php echo $data['nama_lengkap']; ?></div></td>
    <td><div align="center"><?php echo $data['level_user']; ?></div></td>
